    ...
    <div class="achievement-analysis-container">
        ...
        <div class="section-content">
            ...
            >
                ...
                <el-table-column prop="allAmount" label="销售总金额" show-overflow-tooltip >
                </el-table-column>
                <el-table-column prop="allCount" label="销售数量" show-overflow-tooltip>
                </el-table-column>
                <el-table-column prop="guestAmount" label="散客销售金额" show-overflow-tooltip>
                </el-table-column>
                <el-table-column prop="memberAmount" label="会员销售金额" show-overflow-tooltip>
                </el-table-column>
                <el-table-column prop="returnAmount" label="退款金额" show-overflow-tooltip>
                </el-table-column>
                <el-table-column prop="allIncome" label="店铺总收入" show-overflow-tooltip>
                </el-table-column>
            </el-table>
