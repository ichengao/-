<template>
    <div class="modal-container create-member-card-modal" v-if="modalStatus">
        <el-dialog title="会员开卡" :visible.sync="modalStatus" @close='handleCloseModal' >
                ...
                <div class="form-rgt">
                    ...
                    <el-form-item label="上传头像" label-width="100px" class="form-item-box">
                        <el-upload 
                            ...
                            <img v-if="form.headPicture" :src="form.headPicture" class="avatar" width="58px">
...
export default { 
    ...
    computed: {
        modalStatus: {
            get(){
                return this.$store.state.createMemberCardStatus || false
            },
            set(){
    ...
    methods: {
        ...
        handleCloseModal(){
            this.$store.dispatch('closecreateMemberCardStatus')
        },
