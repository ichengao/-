...
<script>
    ...
    export default {
        ...
        computed: {
            modalStatus: {
                get(){
                    return this.$store.state.UpdateServiceModal.status || false
                },
                set(){
        ...
        watch: {
            modalStatus(oldVal,newVal){
                this.modalStatus = this.$store.state.UpdateServiceModal.status;
                if(this.modalStatus){
                    this.form = Object.assign({},this.form,this.$store.state.UpdateServiceModal.data,{createDate: ''})
                }
            }
        },
        methods: {
            handleCloseModal(){
                this.$store.dispatch('closeUpdateService');
            },
                ...
                this.$refs['form'].validate((valid)=>{
                    if(valid){
                        ...
                        requestUpdateProduct(params).then((res)=>{
                            ...
                            EventBus.$emit(UPDATE_SERVICE_LIST);
