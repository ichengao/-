...
<script>
    import { requestCreateAdminStaff,requestGetAllStaff } from '@/services/service';
    ...
    export default {
        ...
        computed: {
            modalStatus: {
                get(){
                    return (this.$store.state.createAdminStaffModalStatus || false)
                },
                set(){
        ...
        watch: {
            modalStatus(oldVal,newVal){
                this.modalStatus = this.$store.state.createAdminStaffModalStatus;
                if(this.modalStatus){
                    this.initData()
                }
            }
        ...
        methods: {
            initData(){
                ...
                requestGetAllStaff(params).then((res)=>{
                    ...
                    this.form.staffId = this.staffOptions[0].staffId;
                })
            },
            handleConfirm(){
                let _this = this;
                this.$refs['form'].validate((valid) => {
                    if (valid) {
                        ...
                        requestCreateAdminStaff(params).then(function(res){
            ...
            handleCloseModal(){
                ...
                this.$store.dispatch('closeCreateAdminStaffModal')
            }
        }
    }
</script>
